...
\"\"\"
Finds regions that significantly overlap with a parent region.
...
\"\"\"
def find_overlapping_regions(parent_region: DetectedObject, countable_regions: List[DetectedObject]) -> List[int]:
